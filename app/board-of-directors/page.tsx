const bod = [
  {
    ...
    image: "",
    description: "Graduate, Allama Iqbal Medical College, Lahore",
  },
  {
    name: "Dr. Ali Hussnain, MD",
    position: "Co-President & Co-Founder",
    image: "",
    description: "Research Fellow, Northwestern University, USA",
  },
  {
    name: "Dr. Rana Muhammad Ahsan",
    position: "Chair of the Board",
    image: "",
    description: "Graduate, Shaikh Zaid Medical College",
  },
  {
    name: "Armeen Masood",
    position: "Secretary-Treasurer",
    image: "",
    description: "MS5, Shalamar Medical College, Lahore",
  },
  {
    name: "Ali Azlan",
    position: "Director for Public Relations & Communication",
    image: "",
    description: "MS2, Allama Iqbal Medical College, Lahore",
  },
  {
    name: "Khawaja Abdul Rehman",
    position: "Director for Human Resources",
    image: "",
    description: "MS3, CMH Lahore Medical College",
  },
  {
    name: "Aleena Ahmed",
    position: "Liaison for Research & Publications",
    image: "",
    description: "MS5, King Edward Medical University, Lahore",
  },
  {
    name: "Ahmed Abdullah",
    position: "Liaison for Advocacy & Networking",
    image: "",
    description: "MS2, Khyber Medical University, Peshawar",
  },
  {
    name: "Dr. Zohaa Faiz",
    position: "Liaison for Mentorship & Education",
    image: "",
    description: "Graduate, Aga Khan University",
  },
];
      ...
      <div className="container-x py-10 ">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
          {bod.map((item, index) => (
            <div
              key={index}
              className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-primary dark:hover:border-transparent"
            >
              <div className="flex flex-col sm:-mx-4 sm:flex-row">
                ...
                <div className="mt-4 sm:mx-4 sm:mt-0">
                  ...
                  <p className="mt-2  text-muted-foreground capitalize group-hover:text-zinc-300">
                    {item.position}
                  </p>
              ...
              <p className="mt-4 text-muted-foreground group-hover:text-zinc-300">
                Description
              </p>
