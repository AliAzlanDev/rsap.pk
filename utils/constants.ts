...
export const committees = {
  researchAndPublications: {
    ...
    image: '/images/rpc-home.jpg',
    color: 'text-[#5f903f]',
    lead: {
      name: 'Talha Iqbal',
      position: 'Liaison for Research & Publications',
      affiliation: 'Graduate, Khyber Medical College, Peshawar, Pakistan',
  ...
  mentorshipAndEducation: {
    ...
    image: '/images/mec-home.jpg',
    color: 'text-[#0e0021]',
    lead: {
      name: 'Shahroze Ahmed',
      position: 'Liaison for Mentorship & Education',
      affiliation:
        'PGY-3, Shaukat Khanum Memorial Cancer Hospital & Research Center, Lahore, Pakistan',
  ...
  advocacyAndNetwroking: {
    ...
    image: '/images/anc-home.jpg',
    color: 'text-[#bd202a]',
    lead: {
      name: '(Vacant)',
      position: 'Liaison for Advocacy & Networking',
      affiliation: 'Class, Institution, City, Country',
...
export const bod = [
  ...
  },
  {
    ...
    description: ['Class', 'Institution', 'City, Country'],
  ...
  },
  {
    ...
    description: ['MS4', 'Allama Iqbal Medical College', 'Lahore, Pakistan'],
    slug: 'ali-azlan',
